...
# -*- encoding: utf-8 -*-
# stub: scout-gear 10.13.1 ruby lib

Gem::Specification.new do |s|
  s.name = "scout-gear".freeze
  s.version = "10.13.1".freeze
  ...
  s.files = [
    ...
    "doc/developer/ConcurrencyModel.md",
    "doc/developer/DesignPrinciples.md",
    "doc/developer/EntitySystem.md",
    "doc/developer/PersistenceEngines.md",
    "doc/developer/TSVInternals.md",
    "doc/developer/WorkflowEngine.md",
    "doc/user/BuildingWorkflows.md",
    "doc/user/CachingData.md",
    "doc/user/Cookbook.md",
    "doc/user/HPCBatchExecution.md",
    "doc/user/ManagingRelationships.md",
    "doc/user/ProcessingTabularData.md",
    "doc/user/RunningParallelWork.md",
    "doc/user/WorkingWithEntities.md",
    "lib/scout-gear.rb",
    "lib/scout.rb",
    ...
    "research/00_scope_and_themes.md",
    "research/design-philosophy-analysis.md",
    "research/downstream-usage.md",
    "research/entity-association-kb-analysis.md",
    "research/identifiers-mechanism.md",
    "research/persistence-concurrency-analysis.md",
    "research/repo-map.md",
    "research/synthesis-report.md",
    "research/tsv-internals-analysis.md",
    "research/validation-report.md",
    "research/workflow-engine-analysis.md",
    "scout-gear.gemspec",
